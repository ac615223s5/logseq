...
//   node .agents/skills/run-logseq/driver.mjs shot [outfile.png]
//   node .agents/skills/run-logseq/driver.mjs smoke
//   node .agents/skills/run-logseq/driver.mjs eval '<js expression run in page>'
//
